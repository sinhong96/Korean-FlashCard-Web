...
//
// Requires env: GIST_ID, and GIST_TOKEN — a classic PAT with the "gist" scope.
// GITHUB_TOKEN (used elsewhere for repo commits) won't work here even if it's set:
// fine-grained PATs can't access the Gist API at all, only classic tokens can.
